import{j as a,m as d}from"./index-SGZV-D-Q.js";const i=({children:o,className:s="",onClick:e,intensity:r="medium"})=>{const l=r==="low"?"bg-white/40":r==="high"?"bg-white/95":"bg-white/70",t=r==="low"?"backdrop-blur-md":r==="high"?"backdrop-blur-3xl":"backdrop-blur-xl";return a.jsxs(d.div,{whileHover:{scale:e?1.005:1,y:e?-2:0},whileTap:{scale:e?.99:1},className:`
