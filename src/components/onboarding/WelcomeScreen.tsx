    ...
    <OnboardingContainer maxWidth="lg">
      <OnboardingSection spacing="loose" align="center">
        ...
        >
          ...
          <p className="text-sm font-bold text-brand-dark uppercase tracking-widest mt-2">
            V5.0
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed mt-4 max-w-sm mx-auto">
            매일의 감정을 기록하고,<br />
